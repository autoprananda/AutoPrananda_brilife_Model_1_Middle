...
<html>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
	<form action="proseseditpropinsi.php" method="post" enctype="multipart/form-data">
    <section class="content">
      <div class="row">
		...
		<?php
				...
				$query="SELECT * from list_provinsi order by id_provinsi='$id_provinsi' DESC";  
            ...
            <form role="form">
              <div class="box-body">
				<div class="form-group">
                  ...
                  <input type="text" name="id_provinsi" value="<?php echo"$h[id_provinsi]";?>" class="form-control">
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">Nama Provinsi</label>
                  <input type="text" name="nama_provinsi" value="<?php echo"$h[nama_provinsi]";?>" class="form-control">
                </div>
				</div>
              <!-- /.box-body -->
              ...
              <div class="box-footer">
                ...
                <a href="listpropinsi.php"/><input class="btn btn-primary" type="button"value="Cancel"></a>
