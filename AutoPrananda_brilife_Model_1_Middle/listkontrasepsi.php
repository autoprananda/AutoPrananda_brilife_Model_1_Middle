        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List Kontrasepsi</h3>
			  <br>
			  <a href="inputkontrasepsi.php"/><input type="button"value="Add"></a>
            </div>
              ...
              <table id="example2" class="table table-bordered table-hover">
                <thead>
					...
					<?php
						...
						$query="SELECT *from list_kontrasepsi ORDER BY id_kontrasepsi ASC";
						...
						if ($result)
						 {
						  while ($h = mysqli_fetch_array($result)) 
						  {
							...
							?>
										<tr>
										<td><?php echo"$h[id_kontrasepsi]"; ?></td>
										<td><?php echo"$h[nama_kontrasepsi]"; ?></td>
										<td style="text-align:center;">
										<?php echo "<a href='editkontrasepsi.php?id_kontrasepsi=$h[id_kontrasepsi]'</a>"?><input type="button" onclick="return confirm('Do you want to edit data <?php echo $h['id_kontrasepsi']; ?> ?');" value="Edit"></a> 														  
										<?php echo "<a href='hapuskontrasepsi.php?id_kontrasepsi=$h[id_kontrasepsi]'</a>"?><input type="button" onclick="return confirm('Do you want to remove data <?php echo $h['id_kontrasepsi']; ?> ?');" value="Delete"></a></td>
