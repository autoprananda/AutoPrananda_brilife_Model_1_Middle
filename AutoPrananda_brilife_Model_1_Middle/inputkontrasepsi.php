...
<html>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
	<form action="prosesinputkontrasepsi.php" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Input Data Kontrasepsi</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="id_kontrasepsi" class="form-control">
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">Nama kontrasepsi</label>
                  <input type="text" name="nama_kontrasepsi" class="form-control">
                </div>
              </div>
              <!-- /.box-body -->
