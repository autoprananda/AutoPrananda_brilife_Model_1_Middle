...
<html>
  ...
  <div class="content-wrapper">
	<form action="proseseditkontrasepsi.php" method="post" enctype="multipart/form-data">
    <section class="content">
      <div class="row">
        <div class="col-md-10">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Kontrasepsi</h3>
            </div>
		<?php
				...
				$query="SELECT * from list_kontrasepsi order by id_kontrasepsi='$id_kontrasepsi' DESC";  
            ...
            <form role="form">
              <div class="box-body">
				<div class="form-group">
                  <label for="exampleInputEmail1">ID Kontrasepsi</label>
                  <input type="text" name="id_kontrasepsi" value="<?php echo"$h[id_kontrasepsi]";?>" class="form-control">
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">Nama Kontrasepsi</label>
                  <input type="text" name="nama_kontrasepsi" value="<?php echo"$h[nama_kontrasepsi]";?>" class="form-control">
                </div>
				</div>

              <div class="box-footer">
                <button type="submit" class="btn btn-primary">Submit</button>
              	<a href="listkontrasepsi.php"/><input class="btn btn-primary" type="button"value="Cancel"></a>
